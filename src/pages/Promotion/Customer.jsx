...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/meoronzd", {
        method: "POST",
  ...
  return (
    ...
    <>
      <Helmet>
        ...
        />
        <meta name="twitter:image" content="https://www.sketchs.co.kr/img/og/customer.jpg" />
        <meta name="twitter:url" content="https://www.sketchs.co.kr/Promotion/Customer" />
          ...
          {JSON.stringify({
            ...
            breadcrumb: {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 2, name: "관심고객등록", item: "https://www.sketchs.co.kr/Promotion/Customer" }
              ]
            }
          })}
        </script>
